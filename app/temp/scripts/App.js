	      ...
	      this.itemsToReveal.each(function () {
	        ...
	        new Waypoint({
	          ...
	          handler: function handler() {
	            //what we want to happen when it's scrolled to
	...
	var Modal = function () {
	  ...
	  _createClass(Modal, [{
	    ...
	    value: function events() {
	      ...
	      this.openModalButton.click(this.openModal.bind(this)); //.bind will make openModal stay to what it's currently set to
